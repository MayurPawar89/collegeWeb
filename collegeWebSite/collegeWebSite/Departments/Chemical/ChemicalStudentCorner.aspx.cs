...
{
    public partial class ChemicalStudentCorner : System.Web.UI.Page
    {
        ...
        private void LoadDataGrid()
        {
            ...
            {
                grdChemStudentCorner.DataSource = _dt;
                grdChemStudentCorner.DataBind();
            }
        }
        ...
        private DataTable GetStudentCorner()
        {
            ...
            try
            {
                _dt = _Student.GetStudentCorner(1);
            }
            catch (Exception)
            {
        ...
        protected void grdChemStudentCorner_RowDataBound(object sender, GridViewRowEventArgs e)
        {
