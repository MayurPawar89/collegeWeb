...
{
    public partial class ComputerStudentCorner : System.Web.UI.Page
    {
        ...
        private void LoadDataGrid()
        {
            ...
            {
                grdCompStudentCorner.DataSource = _dt;
                grdCompStudentCorner.DataBind();
            }
        }
        ...
        private DataTable GetStudentCorner()
        {
            ...
            try
            {
                _dt = _Student.GetStudentCorner(2);
            }
            catch (Exception)
            {
        ...
        protected void grdCompStudentCorner_RowDataBound(object sender, GridViewRowEventArgs e)
        {
